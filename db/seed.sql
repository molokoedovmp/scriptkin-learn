...
INSERT INTO quests (slug, title, tagline, intro, difficulty, steps_count, emoji, status, preview_url, sort_order) VALUES
(
  'submarine-crash',
  'Крушение подлодки',
  ...
  'beginner', 8, '🌊', 'coming_soon', '/quests/submarine-crash/preview.png', 2
),
(
  'midnight-heist',
  'Ограбление галереи',
  ...
  'intermediate', 10, '🖼️', 'coming_soon', '/quests/midnight-heist/preview.png', 3
),
(
  'mars-station',
  'Станция «Арес-9»',
  ...
  'advanced', 12, '🚀', 'coming_soon', '/quests/mars-station/preview.png', 4
)
