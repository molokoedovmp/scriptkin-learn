...
(
  ...
  'beginner', 8, '🌊', 'coming_soon', '/quests/submarine-crash/preview.png', 50000, 2
),
(
  'midnight-heist',
  'Ограбление галереи',
  ...
  'intermediate', 10, '🖼️', 'coming_soon', '/quests/midnight-heist/preview.png', 50000, 3
),
(
  'mars-station',
  'Станция «Арес-9»',
  ...
  'advanced', 12, '🚀', 'coming_soon', '/quests/mars-station/preview.png', 50000, 4
)
