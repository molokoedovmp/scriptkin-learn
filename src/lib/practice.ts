...
const MIDNIGHT_EXPRESS: ServerPracticeDatabase = {
  ...
  emoji: "🚂",
  description:
    "Шесть связанных таблиц ночного поезда: пассажиры, билеты, багаж, маршрут, журнал проводника и контрольная перекличка. Задания не меняют прогресс истории — здесь можно спокойно экспериментировать.",
  tables: [
    {
      name: "passengers",
